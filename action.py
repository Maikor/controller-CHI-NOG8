...
# route_operation_set1(channel, sl_common_types_pb2.SL_OBJOP_ADD)
# os._exit(0)
...
@app.route("/add_first")
def add_first():
    route_operation(channel, sl_common_types_pb2.SL_OBJOP_DELETE, ['44.44.44.45', '18.18.18.40', 'HundredGigE0/0/1/2'])
    route_operation(channel, sl_common_types_pb2.SL_OBJOP_ADD, ['44.44.44.45', '17.17.17.40', 'HundredGigE0/0/1/1'])
    return 'Route injected'


@app.route("/add_second")
def del_first():
    route_operation(channel, sl_common_types_pb2.SL_OBJOP_DELETE, ['44.44.44.45', '17.17.17.40', 'HundredGigE0/0/1/1'])
    route_operation(channel, sl_common_types_pb2.SL_OBJOP_ADD, ['44.44.44.45', '18.18.18.40', 'HundredGigE0/0/1/2'])
    return 'Route injected'
